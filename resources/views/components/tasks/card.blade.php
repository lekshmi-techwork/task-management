...
<div class="bg-white rounded-xl p-5 shadow-lg min-h-[190px]">
    ...
    <div class="flex gap-2 mb-3">
        ...
        <span class="text-[10px] bg-pink-700 text-white px-2 py-1 rounded-full">
            Priority: {{ ucfirst($task->priority) }}
        </span>
    </div>

    <p class="rounded-sm p-1 bg-gray-100 text-[11px] text-slate-500 leading-4 mb-3">
    ...
    <div class="flex justify-between items-end">
        <div class="text-[11px] text-slate-500 leading-4">
            ...
            <p class="text-blue-600 font-semibold">{{ ucfirst($task->priority) }}</p>
        </div>
